...
function stockists() {
	...
	$labels = array(
		'name'                  => _x( 'Stockists', 'Post Type General Name', 'twentyseventeen' ),
		'singular_name'         => _x( 'Stockists', 'Post Type Singular Name', 'twentyseventeen' ),
		'menu_name'             => __( 'Stockists', 'twentyseventeen' ),
		'name_admin_bar'        => __( 'Post Type', 'twentyseventeen' ),
		'archives'              => __( 'Item Archives', 'twentyseventeen' ),
		'attributes'            => __( 'Item Attributes', 'twentyseventeen' ),
		'parent_item_colon'     => __( 'Parent Item:', 'twentyseventeen' ),
		'all_items'             => __( 'All Items', 'twentyseventeen' ),
		'add_new_item'          => __( 'Add New Item', 'twentyseventeen' ),
		'add_new'               => __( 'Add New', 'twentyseventeen' ),
		'new_item'              => __( 'New Item', 'twentyseventeen' ),
		'edit_item'             => __( 'Edit Item', 'twentyseventeen' ),
		'update_item'           => __( 'Update Item', 'twentyseventeen' ),
		'view_item'             => __( 'View Item', 'twentyseventeen' ),
		'view_items'            => __( 'View Items', 'twentyseventeen' ),
		'search_items'          => __( 'Search Item', 'twentyseventeen' ),
	...
	$args = array(
		'label'                 => __( 'Stockists', 'twentyseventeen' ),
		'description'           => __( 'Post Type Description', 'twentyseventeen' ),
		'labels'                => $labels,
...
add_action( 'init', 'stockists', 0 );



add_filter( 'acf/fields/google_map/api', function ( $api ) {
	return array_merge( $api, array(
		'key' => 'AIzaSyBTlOwsAa_ymgAGr4wd7-Z6hdIrVFKKmXc'
	) );
} );
